...
<td class="comment-content">
	...
	<p class="edit-comment"><a href="<?php echo admin_url( "comments.php?action=editcomment&amp;c={$comment->comment_ID}" ); ?>"><?php esc_html_e( 'Edit' ); ?></a></p>
</td>
</tr>
</table>
...
case 'unapprovecomment' :
	...
	if ( '' != wp_get_referer() && ! $noredir && false === strpos(wp_get_referer(), 'comments.php') )
